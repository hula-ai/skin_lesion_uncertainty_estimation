...
from models.my_densenet import DenseNet as MyDenseNet
...
class DenseNetBackbone(Backbone):
    ...
    def validate(self):
        ...
        """
        allowed_backbones = ['densenet121', 'densenet169', 'densenet201', 'my_densenet']
